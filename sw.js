const CACHE = "branje-stevcev-v7";
const APP_SHELL = ["./", "./index.html", "./manifest.webmanifest", "./ocr-robust.js", "./auto-read.js", "./email-share.js"];
...
async function injectScripts(response) {
  ...
  if (!injected.includes("ocr-robust.js")) {
    injected = injected.replace("</body>", '<script src="./ocr-robust.js?v=6"></script></body>');
  }
